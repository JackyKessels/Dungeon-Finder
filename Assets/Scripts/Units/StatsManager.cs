...
public class StatsManager
{
    ...
    public void TakeDamage(AbilityValue abilityValue, bool allowDamageTransfer)
    {
        ...
        if (damageTransferEffect != null && allowDamageTransfer)
        {
            ...
            AbilityValue transferValue = new AbilityValue(abilityValue.value * damageTransfer.percentage, abilityValue.school, abilityValue.abilityType, abilityValue.cannotCrit, abilityValue.cannotMiss, abilityValue.target, damageTransferEffect.caster, abilityValue.color, abilityValue.isUnitTrigger);
