...
public class AbilitySource
{
    ...
    public void TriggerSource(Unit caster, Unit target, int level, float adjacentModifier, bool isUnitTrigger, float abilityMultiplier, AbilityType abilityType)
    {
    ...
    public void TriggerSource(Unit caster, Unit target, float value, bool isUnitTrigger)
    {
        Color color = GeneralUtilities.ConvertString2Color(ColorDatabase.SchoolColor(school));
